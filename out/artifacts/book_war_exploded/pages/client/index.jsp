		...
		$(function(){
			$("#searchBtn").click(function(){
				...
				if(pageNo >= 1 && pageNo <= ${requestScope.page.pageTotal}){
					location.href = "${requestScope.basePath}client/bookServlet?action=page&pageNo=" + pageNo;
				}
			})
		...
		<div id="book">
			<div class="book_cond">
				<form action="client/bookServlet" method="get">
                    <input type="hidden" name="action" value="pageByPrice"></input>
			...
			<div style="text-align: center">
				...
				<c:if test="${not empty sessionScope.cart.items}">
					...
					<div>
						您刚刚将<span id="lastName" style="color: red"></span>加入到了购物车中
					</div>
				</c:if>
