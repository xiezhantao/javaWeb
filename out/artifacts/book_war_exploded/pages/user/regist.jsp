	...
	<script>
		$(function(){
			...
			$("#code_img").click(function(){
				this.src = "${requestScope.basePath}kaptcha.jpg?d="+new Date();
			})

			//给注册绑定单击事件
			$("#sub_btn").click(function(){
				//获取提示结果区域元素
				var err = $("span.errorMsg");
						...
						<div class="login_box">
							...
							<div class="form">
								<form action="userServlet" method="post">
									...
									<img alt="" id="code_img" src="kaptcha.jpg" style="float: right; width:90px; height: 40px;  margin-right: 40px">
									<br />
									<br />
